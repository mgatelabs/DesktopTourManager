(function(){
    ...
    MG.preview.Preview.prototype = ({
        ...
        _getAtlasTexture: function(index) {
            var texture = new THREE.TextureLoader().load('./images/atlas/atlas_' + index + '.png');
        ...
        generateIcon: function(index){
            ...
            var material = new THREE.MeshBasicMaterial( {side: THREE.FrontSide} ); // FrontSide || DoubleSide
